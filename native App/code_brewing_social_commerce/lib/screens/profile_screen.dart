          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            background: Column(
              children: [
                ...
                Text(profileModel.name,style: TextStyle(color: Colors.white),)
              ],
            ),
          ),
        ),SliverList(
          delegate: SliverChildListDelegate(
            List.generate(profileModel.orders.length, (index)  {
              return ListTile(
                leading: Image.network(profileModel.orders[index].item.pictureLink),
